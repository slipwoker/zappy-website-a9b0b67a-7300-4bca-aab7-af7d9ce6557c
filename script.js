    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Goblin Shark uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a9b0b67a-7300-4bca-aab7-af7d9ce6557c',
                    name: data.name || '',
                    email: data.email || '',
